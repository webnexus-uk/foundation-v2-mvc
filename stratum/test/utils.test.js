...
describe("Test utility functionality", () => {
  ...
  test("Test implemented getMVCOPCodes", () => {
    expect(utils.getMVCOPCodes("OP_0")).toBe(0);
    expect(utils.getMVCOPCodes("OP_PUSHDATA1")).toBe(76);
    expect(utils.getMVCOPCodes("OP_PUSHDATA2")).toBe(77);
    expect(utils.getMVCOPCodes("OP_PUSHDATA4")).toBe(78);
    expect(utils.getMVCOPCodes("OP_1NEGATE")).toBe(79);
    expect(utils.getMVCOPCodes("OP_RESERVED")).toBe(80);
    expect(utils.getMVCOPCodes("OP_DUP")).toBe(118);
    expect(utils.getMVCOPCodes("OP_EQUAL")).toBe(135);
    expect(utils.getMVCOPCodes("OP_EQUALVERIFY")).toBe(136);
    expect(utils.getMVCOPCodes("OP_HASH160")).toBe(169);
    expect(utils.getMVCOPCodes("OP_CHECKSIG")).toBe(172);
    expect(utils.getMVCOPCodes("OP_DEFAULT")).toBe(0);
  });
